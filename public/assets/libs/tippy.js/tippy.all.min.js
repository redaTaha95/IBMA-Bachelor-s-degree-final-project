(function (t, e) {
    ...
    function m(t) {
        ...
        return {
            tooltip: e(qt.TOOLTIP),
            backdrop: e(qt.BACKDROP),
            content: e(qt.CONTENT),
            arrow: e(qt.ARROW) || e(qt.ROUND_ARROW)
        }
    }
    ...
    function A(t) {
        var e = t.body, a = t.documentElement, i = g(10) && getComputedStyle(a);
        return {height: O('Height', e, a, i), width: O('Width', e, a, i)}
    }
    ...
    function S(t) {
        ...
        var o = {left: e.left, top: e.top, width: e.right - e.left, height: e.bottom - e.top},
            r = 'HTML' === t.nodeName ? A(t.ownerDocument) : {}, p = r.width || t.clientWidth || o.right - o.left,
    ...
    function Y(t, e) {
        ...
        a && o && (p.top = Bt(p.top, 0), p.left = Bt(p.left, 0));
    ...
    function P(t) {
        var e = !!(1 < arguments.length && void 0 !== arguments[1]) && arguments[1],
            a = t.ownerDocument.documentElement, i = Y(t, a), o = Bt(a.clientWidth, window.innerWidth || 0),
            r = Bt(a.clientHeight, window.innerHeight || 0), p = e ? 0 : E(a), n = e ? 0 : E(a, 'left'),
    ...
    function I(t, e, a, i) {
        ...
        if ('viewport' === i) r = P(p, o); else {
            ...
            if ('HTML' === n.nodeName && !X(p)) {
                var l = A(t.ownerDocument), d = l.height, c = l.width;
                r.top += s.top - s.marginTop, r.bottom = d + s.top, r.left += s.left - s.marginLeft, r.right = c + s.left
            } else r = s
        }
        a = a || 0;
        var m = 'number' == typeof a;
        return r.left += m ? a : a.left || 0, r.top += m ? a : a.top || 0, r.right -= m ? a : a.right || 0, r.bottom -= m ? a : a.bottom || 0, r
    }
    ...
    function _(t, e, a) {
        var i = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : null, o = i ? D(e) : k(e, a);
        return Y(a, o, i)
    }
    ...
    function W(t, e, a) {
        a = a.split('-')[0];
        var i = N(t), o = {width: i.width, height: i.height}, r = -1 !== ['right', 'left'].indexOf(a),
    ...
    function G(t, e, a, i) {
        ...
        r.addEventListener(e, a, {passive: !0}), o || G(y(r.parentNode), e, a, i), i.push(r)
    }

    function Q(t, e, a, i) {
        a.updateBound = i, V(t).addEventListener('resize', a.updateBound, {passive: !0});
        var o = y(t);
        return G(o, 'scroll', a.updateBound, a.scrollParents), a.scrollElement = o, a.eventsEnabled = !0, a
    }
    ...
    function rt(t) {
        var e = !!(1 < arguments.length && void 0 !== arguments[1]) && arguments[1], a = le.indexOf(t),
            i = le.slice(a + 1).concat(le.slice(0, a));
    ...
    function pt(t, e, a, i) {
        ...
        if ('vh' === p || 'vw' === p) {
            var l;
            return l = 'vh' === p ? Bt(document.documentElement.clientHeight, window.innerHeight || 0) : Bt(document.documentElement.clientWidth, window.innerWidth || 0), l / 100 * r
        }
        return r
    }
    ...
    function kt() {
        var t = this._(he).lastTriggerEvent;
        return this.options.followCursor && !Ft.usingTouch && t && 'focus' !== t.type
    }

    function Et(t) {
        var e = yt(t.target, this.options.target);
        if (e && !e._tippy) {
            var a = e.getAttribute('title') || this.title;
            a && (e.setAttribute('title', a), _t(e, Qt({}, this.options, {target: null})), Tt.call(e._tippy, t))
        }
    }

    function Tt(t) {
        var e = this, a = this.options;
        if (St.call(this), !this.state.visible) {
            if (a.target) return void Et.call(this, t);
            if (this._(he).isPreparingToShow = !0, a.wait) return void a.wait.call(this.popper, this.show.bind(this), t);
            if (kt.call(this)) {
                this._(he).followCursorListener || Yt.call(this);
                var i = m(this.popper), o = i.arrow;
                o && (o.style.margin = '0'), document.addEventListener('mousemove', this._(he).followCursorListener)
            }
            var r = gt(a.delay, 0);
            r ? this._(he).showTimeout = setTimeout(function () {
                e.show()
            }, r) : this.show()
        }
    }
    ...
    function Lt() {
        var t = this;
        if (St.call(this), !!this.state.visible) {
            this._(he).isPreparingToShow = !1;
            var e = gt(this.options.delay, 1);
            e ? this._(he).hideTimeout = setTimeout(function () {
    ...
    function Ot() {
        ...
        return {
            onTrigger: function (e) {
                if (t.state.enabled) {
                    var a = Ft.supportsTouch && Ft.usingTouch && -1 < ['mouseenter', 'mouseover', 'focus'].indexOf(e.type);
                    a && t.options.touchHold || (t._(he).lastTriggerEvent = e, 'click' === e.type && 'persistent' !== t.options.hideOnClick && t.state.visible ? Lt.call(t) : Tt.call(t, e))
                }
            }, onMouseLeave: function (e) {
                if (!(-1 < ['mouseleave', 'mouseout'].indexOf(e.type) && Ft.supportsTouch && Ft.usingTouch && t.options.touchHold)) {
                    if (t.options.interactive) {
                        var a = Lt.bind(t), i = function e(i) {
                            var o = yt(i.target, qt.REFERENCE), r = yt(i.target, qt.POPPER) === t.popper,
                                p = o === t.reference;
                            r || p || mt(i, t.popper, t.options) && (document.body.removeEventListener('mouseleave', a), document.removeEventListener('mousemove', e), Lt.call(t, e))
                        };
                ...
                if (!(e.target !== t.reference || Ft.usingTouch)) {
                    if (t.options.interactive) {
                        ...
                        if (yt(e.relatedTarget, qt.POPPER)) return
                    }
                    Lt.call(t)
                }
    ...
    function At() {
        var t = this, e = this.popper, a = this.reference, i = this.options, o = m(e), r = o.tooltip,
            p = i.popperOptions, n = 'round' === i.arrowType ? qt.ROUND_ARROW : qt.ARROW, s = r.querySelector(n),
            l = Qt({placement: i.placement}, p || {}, {
                modifiers: Qt({}, p ? p.modifiers : {}, {
                    arrow: Qt({element: n}, p && p.modifiers ? p.modifiers.arrow : {}),
                    flip: Qt({
                        enabled: i.flip,
                        padding: i.distance + 5,
                        behavior: i.flipBehavior
                    }, p && p.modifiers ? p.modifiers.flip : {}),
                    offset: Qt({offset: i.offset}, p && p.modifiers ? p.modifiers.offset : {})
                }), onCreate: function () {
    ...
    function Ct(t) {
        var e = this.options;
        if (this.popperInstance ? (this.popperInstance.scheduleUpdate(), e.livePlacement && !kt.call(this) && this.popperInstance.enableEventListeners()) : (this.popperInstance = At.call(this), !e.livePlacement && this.popperInstance.disableEventListeners()), !kt.call(this)) {
    ...
    function St() {
        var t = this._(he), e = t.showTimeout, a = t.hideTimeout;
        clearTimeout(e), clearTimeout(a)
    }

    function Yt() {
        var t = this;
        this._(he).followCursorListener = function (e) {
            var a = t._(he).lastMouseMoveEvent = e, i = a.clientX, o = a.clientY;
    ...
    function Xt(t) {
        ...
        if (window.MutationObserver) {
            ...
            o.observe(e, i), this._(he).mutationObservers.push(o)
        }
    }
    ...
    function It(t, e) {
        return t.reduce(function (t, a) {
            var i = ye, o = c(a, e.performance ? e : d(a, e)), r = a.getAttribute('title');
            if (!r && !o.target && !o.html && !o.dynamicTitle) return t;
            a.setAttribute(o.target ? 'data-tippy-delegate' : 'data-tippy', ''), f(a);
            var p = s(i, r, o),
                n = new ue({id: i, reference: a, popper: p, options: o, title: r, popperInstance: null});
            o.createPopperInstanceOnInit && (n.popperInstance = At.call(n), n.popperInstance.disableEventListeners());
            var h = Ot.call(n);
            return n.listeners = o.trigger.trim().split(' ').reduce(function (t, e) {
                return t.concat(l(e, a, h, o))
            }, []), o.dynamicTitle && Xt.call(n, {
            ...
            }), a._tippy = n, p._tippy = n, p._reference = a, t.push(n), ye++, t
        }, [])
    }

    function Rt(t) {
        var e = a(document.querySelectorAll(qt.POPPER));
    ...
    function Ht(t) {
        var i = function () {
            ...
            return function () {
                ...
                20 > e - t && (Ft.usingTouch = !1, document.removeEventListener('mousemove', o), !Ft.iOS && document.body.classList.remove('tippy-touch'), Ft.onUserInputChange('mouse')), t = e
            }
        }();
        document.addEventListener('click', function (t) {
            if (!(t.target instanceof Element)) return Rt();
            var e = yt(t.target, qt.REFERENCE), a = yt(t.target, qt.POPPER);
            if (!(a && a._tippy && a._tippy.options.interactive)) {
                if (e && e._tippy) {
                    var i = e._tippy.options, o = -1 < i.trigger.indexOf('click'), r = i.multiple;
                    if (!r && Ft.usingTouch || !r && o) return Rt(e._tippy);
            ...
            a && a.blur && e.call(a, qt.REFERENCE) && a.blur()
    ...
    function _t(e, a, i) {
        Ft.supported && !ge && (Ht(we), ge = !0), t(e) && r(e), a = Qt({}, jt, a);
        var p = o(e), n = p[0];
        return {
            selector: e,
            options: a,
            tooltips: Ft.supported ? It(i && n ? [n] : p, a) : [],
            destroyAll: function () {
    ...
    var Nt = Math.min, Mt = Math.round, Wt = Math.floor, Bt = Math.max, Ut = 'undefined' != typeof window,
        zt = Ut && /MSIE |Trident\//.test(navigator.userAgent), Ft = {};
    Ut && (Ft.supported = 'requestAnimationFrame' in window, Ft.supportsTouch = 'ontouchstart' in window, Ft.usingTouch = !1, Ft.dynamicInputDetection = !0, Ft.iOS = /iPhone|iPad|iPod/.test(navigator.platform) && !window.MSStream, Ft.onUserInputChange = function () {
    });
    for (var qt = {
        POPPER: '.tippy-popper',
    ...
    }, Kt = Ft.supported && Object.keys(jt), Vt = function (t, e) {
        ...
        return t
    }, Zt = 'undefined' != typeof window && 'undefined' != typeof document, $t = ['Edge', 'Trident', 'Firefox'], Jt = 0, te = 0; te < $t.length; te += 1) if (Zt && 0 <= navigator.userAgent.indexOf($t[te])) {
        Jt = 1;
        break
    }
    var i = Zt && window.Promise, ee = i ? function (t) {
            var e = !1;
            return function () {
        ...
        ie = Zt && /MSIE 10/.test(navigator.userAgent), oe = function (t, e) {
            if (!(t instanceof e)) throw new TypeError('Cannot call a class as a function')
        }, re = function () {
            function t(t, e) {
                for (var a, o = 0; o < e.length; o++) a = e[o], a.enumerable = a.enumerable || !1, a.configurable = !0, 'value' in a && (a.writable = !0), Object.defineProperty(t, a.key, a)
        ...
        le = se.slice(3), de = {FLIP: 'flip', CLOCKWISE: 'clockwise', COUNTERCLOCKWISE: 'counterclockwise'},
        ce = function () {
            function t(e, a) {
                var i = this, o = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {};
                oe(this, t), this.scheduleUpdate = function () {
                    return requestAnimationFrame(i.update)
                }, this.update = ee(this.update.bind(this)), this.options = ne({}, t.Defaults, o), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = e && e.jquery ? e[0] : e, this.popper = a && a.jquery ? a[0] : a, this.options.modifiers = {}, Object.keys(ne({}, t.Defaults.modifiers, o.modifiers)).forEach(function (e) {
    ...
    ce.Utils = ('undefined' == typeof window ? global : window).PopperUtils, ce.placements = se, ce.Defaults = {
        placement: 'bottom', positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
                ...
                order: 100, enabled: !0, fn: function (t) {
                    ...
                    if (i) {
                        var o = t.offsets, r = o.reference, p = o.popper, n = -1 !== ['bottom', 'top'].indexOf(a),
                            ...
                            d = {start: pe({}, s, r[s]), end: pe({}, s, r[s] + r[l] - p[l])};
                        t.offsets.popper = ne({}, p, d[i])
                    }
                    return t
                }
            },
            ...
            preventOverflow: {
                order: 300, enabled: !0, fn: function (t, e) {
                    ...
                    var l = e.priority, d = t.offsets.popper, c = {
                        primary: function (t) {
                            var a = d[t];
                            return d[t] < s[t] && !e.escapeWithReference && (a = Bt(d[t], s[t])), pe({}, t, a)
                        }, secondary: function (t) {
                            var a = 'right' === t ? 'left' : 'top', i = d[a];
                            return d[t] > s[t] && !e.escapeWithReference && (i = Nt(d[a], s[t] - ('right' === t ? d.width : d.height))), pe({}, a, i)
                        }
                    };
            ...
            arrow: {
                order: 500, enabled: !0, fn: function (t, e) {
                    ...
                    var o = t.placement.split('-')[0], r = t.offsets, p = r.popper, n = r.reference,
                        ...
                        c = d.toLowerCase(), m = s ? 'left' : 'top', f = s ? 'bottom' : 'right', h = N(i)[l];
                    ...
                    return x = Bt(Nt(p[l] - h, x), 0), t.arrowElement = i, t.offsets.arrow = (a = {}, pe(a, c, Mt(x)), pe(a, m, ''), a), t
                }, element: '[x-arrow]'
            },
            flip: {
                order: 600, enabled: !0, fn: function (t, e) {
                    ...
                    return p.forEach(function (n, s) {
                        ...
                        (m || y || w) && (t.flipped = !0, (m || y) && (i = p[s + 1]), w && (r = ot(r)), t.placement = i + (r ? '-' + r : ''), t.offsets.popper = ne({}, t.offsets.popper, W(t.instance.popper, t.offsets.reference, t.placement)), t = z(t.instance.modifiers, t, 'flip'))
                    }), t
            ...
            hide: {
                order: 800, enabled: !0, fn: function (t) {
                    ...
                    var e = t.offsets.reference, a = B(t.instance.modifiers, function (t) {
            ...
            computeStyle: {
                order: 850, enabled: !0, fn: function (t, e) {
                    var a = e.x, i = e.y, o = t.offsets.popper, r = B(t.instance.modifiers, function (t) {
                    ...
                    var p = void 0 === r ? e.gpuAcceleration : r, n = w(t.instance.popper), s = S(n),
                        ...
                        h = void 0, b = void 0;
                    if (b = 'bottom' == c ? 'HTML' === n.nodeName ? -n.clientHeight + d.bottom : -s.height + d.bottom : d.top, h = 'right' == m ? 'HTML' === n.nodeName ? -n.clientWidth + d.right : -s.width + d.right : d.left, p && f) l[f] = 'translate3d(' + h + 'px, ' + b + 'px, 0)', l[c] = 0, l[m] = 0, l.willChange = 'transform'; else {
                        var u = 'bottom' == c ? -1 : 1, y = 'right' == m ? -1 : 1;
                        l[c] = b * u, l[m] = h * y, l.willChange = c + ', ' + m
                    }
                    var g = {"x-placement": t.placement};
                    return t.attributes = ne({}, g, t.attributes), t.styles = ne({}, l, t.styles), t.arrowStyles = ne({}, t.offsets.arrow, t.arrowStyles), t
            ...
            applyStyle: {
                order: 900, enabled: !0, fn: function (t) {
                    ...
                    var r = _(o, e, t, a.positionFixed),
                        p = H(a.placement, r, e, t, a.modifiers.flip.boundariesElement, a.modifiers.flip.padding);
    ...
    var me = {};
    if (Ut) {
        var fe = Element.prototype;
        me = fe.matches || fe.matchesSelector || fe.webkitMatchesSelector || fe.mozMatchesSelector || fe.msMatchesSelector || function (t) {
            for (var e = (this.document || this.ownerDocument).querySelectorAll(t), a = e.length; 0 <= --a && e.item(a) !== this;) ;
            return -1 < a
        }
    }
    var e = me, he = {}, be = function (t) {
        return function (e) {
            return e === he && t
        }
    }, ue = function () {
            ...
            key: 'show', value: function (t) {
                ...
                if (!this.state.destroyed && this.state.enabled) {
                    var a = this.popper, i = this.reference, o = this.options, r = m(a), n = r.tooltip, s = r.backdrop,
                        l = r.content;
                    return o.dynamicTitle && !i.getAttribute('data-original-title') || i.hasAttribute('disabled') ? void 0 : i.refObj || document.documentElement.contains(i) ? void (o.onShow.call(a, this), t = gt(void 0 === t ? o.duration : t, 0), xt([a, n, s], 0), a.style.visibility = 'visible', this.state.visible = !0, Ct.call(this, function () {
                        if (e.state.visible) {
                            if (kt.call(e) || e.popperInstance.scheduleUpdate(), kt.call(e)) {
                                e.popperInstance.disableEventListeners();
                                var r = gt(o.delay, 0), d = e._(he).lastTriggerEvent;
                                d && e._(he).followCursorListener(r && e._(he).lastMouseMoveEvent ? e._(he).lastMouseMoveEvent : d)
                            }
            ...
            key: 'hide', value: function (t) {
                ...
                if (!this.state.destroyed && this.state.enabled) {
                    var a = this.popper, i = this.reference, o = this.options, r = m(a), p = r.tooltip, n = r.backdrop,
                        s = r.content;
                    o.onHide.call(a, this), t = gt(void 0 === t ? o.duration : t, 1), o.updateDuration || p.classList.remove('tippy-notransition'), o.interactive && i.classList.remove('tippy-active'), a.style.visibility = 'hidden', this.state.visible = !1, xt([p, n, n ? s : null], t), wt([p, n], 'hidden'), o.interactive && -1 < o.trigger.indexOf('click') && vt(i), Dt.call(this, t, function () {
    ...
    return _t.version = '2.6.0', _t.browser = Ft, _t.defaults = jt, _t.one = function (t, e) {
