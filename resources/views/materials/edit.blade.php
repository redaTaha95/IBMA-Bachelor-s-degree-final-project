                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="simpleinput" class="form-control" name="material_code" placeholder="{{ __('material.material_code') }}" value="{{old('material_code', $material->material_code)}}">
                                    </div>
