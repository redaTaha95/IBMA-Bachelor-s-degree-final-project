                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('purchase.title12') }}</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{__('purchase.title13')}}</a></li>
                            <li class="breadcrumb-item active">{{__('purchase.title14')}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{__('purchase.introduction4')}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            ...
                            <div class="tab-content pt-0">
                                <div class="tab-pane active show" id="product-1-item">
                                    @if($purchase->logo)
                                        <img src="{{asset('storage/purchases/'.$purchase->logo)}}" alt="image" class="img-fluid mx-auto d-block rounded">
                                    @else
                        ...
                        <div class="col-lg-7">
                            <div class="pl-xl-3 mt-3 mt-xl-0">
                                <h4 class="mb-3">{{$purchase->name}}</h4>
                                ...
                                <p class="text-muted mb-4">{{$purchase->description}}</p>
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div>
