    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">{{__('product.add_product')}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('product.general_information')}}</h4>
                        ...
                        <form action="{{route('products.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="simpleinput" class="form-control" name="title" placeholder="{{__('product.title')}}" value="{{old('title')}}">
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select id="inputState" name="supplier_id" class="form-control placeholder">
                                            ...
                                            @foreach($suppliers as $supplier)
                                                <option value="{{$supplier->id}}" {{old('supplier_id') == $supplier->id ? 'selected' : ''}}>{{$supplier->full_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="example-textarea" name="description" rows="8">{{old('description')}}</textarea>
                                    </div>
                            ...
                            <!-- end row-->
                            <div class="row">
                                <button type="submit" class="btn btn-success btn-rounded waves-effect waves-light">{{__('product.add')}}</button>
